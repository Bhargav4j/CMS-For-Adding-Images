...
public class PictureService : IPictureService
{
    ...
    public PictureService(IPictureRepository pictureRepository, ILogger<PictureService> logger)
    {
    ...
    public async Task<IEnumerable<Picture>> GetByGalleryTypeAsync(int galleryTypeId, CancellationToken cancellationToken = default)
    {
        try
        {
            _logger.LogInformation("Retrieving pictures for gallery type: {GalleryTypeId}", galleryTypeId);
